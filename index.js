  ...
  try {
    ...
    const response = await anthropic.messages.create({
      ...
      messages: [{ role: 'user', content: [
        ...
        { type: 'text', text: exampleText + 'ค้นหาและอ่านเลขออเดอร์จากภาพนี้ ภาพอาจหมุนหรือเอียงให้อ่านในทุกทิศทาง เลขออเดอร์คือตัวอักษรและตัวเลขปนกัน ยาว 10-20 ตัว อยู่บรรทัดที่ 3-4 ของใบงาน เช่น 260416IG9B3BBWB หรือ 583776830874748554 ตอบเป็น JSON เท่านั้น {"order_numbers":["เลข1"],"unclear":false} กฎ: 1) ไม่ใช่ ID สั้นๆหลัง platform เช่น lookmee180158 2) ถ้าสติ๊กเกอร์บังตัวเลขบางส่วนให้ unclear:true 3) ถ้าเบลอจนอ่านไม่ออกให้ unclear:true 4) ห้ามเดาตัวเลขที่มองไม่เห็น' }
      ]}]
    });
