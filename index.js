...
const { data: examples } = await supabase
    ...
    content.push({ type: 'text', text: exampleText + 'ส่งภาพ 2 เวอร์ชั่น ต้นฉบับและหมุน 270 องศา ให้เลือกเวอร์ชั่นที่อ่านเลขออเดอร์ได้ชัดที่สุด เลขออเดอร์อยู่บรรทัดที่ 3 ถัดจากวันที่และชื่อ platform+ลูกค้า รูปแบบเช่น 260417ZXA1VJVQ หรือ 583776830874748554 หรือ 1082651067631474 ตอบเป็น JSON เท่านั้น {"order_numbers":["เลข1"],"unclear":false} กฎ: 1) ไม่ใช้วันที่ 2) ไม่ใช้ชื่อลูกค้ากรณีที่มีเลขออเดอร์ ถ้าเลขออเดอร์โดนปิดหรือไม่มีเลยให้ใส่ platform_ชื่อลูกค้า แทนใน order_numbers เช่น tiktok: bemysine และ unclear:false ในกรณีนี้ 3) ถ้ามีสติ๊กเกอร์หรือมีอะไรปิดทับเลขออเดอร์ ถึงจะเห็นแบบลางๆก็ให้ unclear:true ยกเว้นกรณีไม่มีเลขออเดอร์ให้ทำตามข้อ 6 แทน 4) ถ้าไม่มั่นใจให้ unclear:true 5) ห้ามเดา' });
